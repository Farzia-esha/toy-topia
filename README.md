...
🔍 Browse Popular Toys with interactive card layout

📦 Toy Details Page (Protected Route)

📝 “Try Now” form to submit toy

💾 My Tried Toys section with remove functionality

🔔 Toast notifications for successful toy tries

🛠️ Firebase Authentication (Email/Password & Google login)
